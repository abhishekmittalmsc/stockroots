...
export default function Accord() {
  ...
  onChange={handleChange('panel1')}>
        ...
        <Typography style={{ color: '#0099A9', fontFamily: 'Arial' }}>
 ...
 >
        <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
        <Typography style={{ color: '#EA6103', fontFamily: 'Arial' }}>
        <Lens style={{ fontSize: 'inherit', marginRight: 5 }} />
 ...
 >
        <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
        <Typography style={{ color: '#F69F1E', fontFamily: 'Arial' }}>
        <Lens style={{ fontSize: 'inherit', marginRight: 5 }} />
 ...
 >
        <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
        <Typography style={{ color: '#E9B0B3', fontFamily: 'Arial' }}>
        <Lens style={{ fontSize: 'inherit', marginRight: 5 }} />
 ...
 >
        <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
        <Typography style={{ color: '#0070C0', fontFamily: 'Arial' }}>
        <Lens style={{ fontSize: 'inherit', marginRight: 5 }} />
 ...
 >
        <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
        <Typography style={{ color: '#3A5723', fontFamily: 'Arial' }}>
        <Lens style={{ fontSize: 'inherit', marginRight: 5 }} />
 ...
 >
        <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
        <Typography style={{ color: '#9D93AE', fontFamily: 'Arial' }}>
        <Lens style={{ fontSize: 'inherit', marginRight: 5 }} />
 ...
 >
        <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
        <Typography style={{ color: '#EA5E66', fontFamily: 'Arial' }}>
        <Lens style={{ fontSize: 'inherit', marginRight: 5 }} />
